...
class ForwardModelDataset(torch.utils.data.Dataset):
    def __init__(self, path):
        ...
        self.pressure_mean = 336.26219848632815
        self.pressure_std = 130.7361669921875
        self.co2_mean = 0.03664950348436832
        self.co2_std = 0.13080736815929414

        self.ft_min = 0.0
        self.ft_max = 28074.49609375
    ...
    for epoch in tqdm_epoch:
        ...
        if epoch % 25 == 0:
            ...
            for i in range(4):
                ...
                plt.imshow(x[i, 0, :, :, -1])
                plt.axis('off')
            plt.savefig('forward_model_samples.png')
